...
const NewsMe = () => (
  <div className="project-child">
    ...
    <div className="project-child-description">
      ...
      <p>NewsMe is a frontend application built in a pair coding hackathon. It utilises the News API and openWeather API to provide users with the most popular news stories via a keyword search. It also allows users to grab a snapshot of the weather or generate a 5 day forecast.</p>
